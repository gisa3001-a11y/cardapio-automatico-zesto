...
def test_readiness_mantem_percentuais_brutos_e_pode_ficar_elegivel():
    ...
    net=[
        ...
        {"caso":"Saipos","dom":{"title":"Faca o seu pedido!","money_mentions":3,"product_word_mentions":1},"requests":[{"resource_type":"document","status":200,"path":"/"},{"resource_type":"fetch","status":200,"path":"/v1/stores"}]},
    ]
    out=avaliar_readiness(report,net)
